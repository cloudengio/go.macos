// panic: field Binary: failed to parse tag: keychain-plugin,,direct path to the plugin binary, leave empty to use the default
//
// goroutine 1 [running]:
// cloudeng.io/cmdutil/subcmd.(*CurrentCommand).MustRunner(0x30a32f663600?, 0x30a32f585d28?, {0x100a38190?, 0x30a32f61a480?})
//
...
//
// cloudeng.io/cmdutil/subcmd.(*extension).Set(0x30a32f63c880?, 0x30a32f63c880?)
//
